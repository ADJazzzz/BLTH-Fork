...
(async function (vue, pinia$1, _, ElementPlusIconsVue, luxon, CryptoJS, ElementPlus, hotkeys) {
  ...
  const PanelHeader = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-e675db5f"]]);
  ...
  class DailyRewardInfo extends BaseModule {
    ...
    async getDailyRewardInfo() {
      ...
      if (Object.values(MainSiteTasks).some(
        (t) => t.enabled && !isTimestampToday(t._lastCompleteTime)
      )) {
        try {
  ...
  class DynamicVideos extends BaseModule {
    ...
    async getDynamicVideos() {
      const MainSiteTasks = this.moduleStore.moduleConfig.DailyTasks.MainSiteTasks;
      if (Object.entries(MainSiteTasks).filter(([key]) => ["watch", "share", "coin"].includes(key)).some(
    ...
    async run() {
      ...
      setTimeout(async () => {
        ...
        firstPageMedals == null ? void 0 : firstPageMedals.forEach((firstPageMedal) => {
          var _a2;
          if ((_a2 = biliStore.fansMedals) == null ? void 0 : _a2.every(
    ...
    getRoomidUidList() {
      ...
      if (biliStore.filteredFansMedals) {
        return biliStore.filteredFansMedals.filter(
          (medal) => (this.config.includeHighLevelMedals ? true : medal.medal.level < 20) && (this.medalTasksConfig.isWhiteList ? this.medalTasksConfig.roomidList.includes(medal.room_info.room_id) : !this.medalTasksConfig.roomidList.includes(
  ...
  class RoomHeart {
    ...
    start() {
      if (!this.buvid) {
        this.logger.error(
          `缺少buvid，无法为直播间 ${this.roomID} 执行观看直播任务，请尝试刷新页面`
        );
        return;
      }
    ...
    async E() {
      ...
      try {
        ...
        this.logger.error(
          `BAPI.liveTrace.E(${this.id}, ${this.device}, ${this.ruid}) 出错`,
          error
        );
      }
    }
  ...
  class WatchTask2 extends BaseModule {
    ...
    getRoomidUidList() {
      ...
      if (biliStore.filteredFansMedals) {
        return biliStore.filteredFansMedals.filter(
          (medal) => medal.medal.level < 20 && (this.medalTasksConfig.isWhiteList ? this.medalTasksConfig.roomidList.includes(medal.room_info.room_id) : !this.medalTasksConfig.roomidList.includes(
            medal.room_info.room_id
          ))
        ).map((medal) => [medal.room_info.room_id, medal.medal.target_id]).slice(0, 199);
      } else {
  ...
  class GroupSignTask extends BaseModule {
    ...
    async sign(group_id, owner_uid) {
      try {
        ...
        this.logger.error(
          `应援团签到 应援团ID = ${group_id} 拥有者UID = ${owner_uid} 出错`,
          error
        );
      }
    }
      ...
      if (this.config.enabled) {
        if (!isTimestampToday(this.config._lastCompleteTime, 8, 5)) {
          ...
          if (!isNowIn(0, 0, 8, 5)) {
            ...
            this.logger.log(
              "昨天的应援团签到任务已经完成过了，等到今天早上八点零五分再次执行"
            );
          }
        }
      }
        ...
        if (this.isYearVip()) {
          if (ts() >= this.config._nextReceiveTime) {
            ...
            if (list) {
              ...
              this.status = "done";
              this.config._nextReceiveTime = Math.max(
                ...list.map((i) => i.period_end_unix)
              );
            }
          } else {
          ...
          () => {
            ...
            if (targetQuality) {
              if (playerInfo.quality !== targetQuality.qn) {
                ...
                this.logger.log(
                  `已将画质切换为${this.config.qualityDesc}`,
                  targetQuality
                );
              } else {
  ...
  __publicField(RemoveGameParty, "runOnMultiplePages", true);
  ...
  const _withScopeId$1 = (n) => (vue.pushScopeId("data-v-a6281aa6"), n = n(), vue.popScopeId(), n);
              ...
              vue.createVNode(_component_el_space, { wrap: "" }, {
                default: vue.withCtx(() => [
                  ...
                  vue.createVNode(_component_el_switch, {
                    ...
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => vue.unref(config).medalTasks.like.includeHighLevelMedals = $event),
              ...
              vue.createVNode(_component_el_space, { wrap: "" }, {
                default: vue.withCtx(() => [
                  vue.createVNode(_component_el_switch, {
                    ...
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => vue.unref(config).medalTasks.danmu.enabled = $event),
                    "active-text": "发送弹幕"
                  }, null, 8, ["modelValue"]),
                  vue.createVNode(_component_el_button, {
                    ...
                    onClick: _cache[4] || (_cache[4] = ($event) => medalDanmuPanelVisible.value = !medalDanmuPanelVisible.value)
                  }, {
                    default: vue.withCtx(() => [
  ...
  const LiveTasks = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-a6281aa6"]]);
              ...
              vue.createVNode(_component_el_space, { wrap: "" }, {
                default: vue.withCtx(() => [
                  vue.createVNode(_component_el_switch, {
                    ...
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => vue.unref(config).removeGiftPopover.enabled = $event),
              ...
              vue.createVNode(_component_el_space, { wrap: "" }, {
                default: vue.withCtx(() => [
                  vue.createVNode(_component_el_switch, {
                    ...
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => vue.unref(config).removeGameParty.enabled = $event),
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-d9fcd727"]]);
  const cssLoader = (e) => {
  ...
  const help_info = {
      ...
      MainSiteTasks: {
        ...
        coin: {
          ...
          message: vue.h("p", [
            ...
            vue.h(
              "div",
              "从动态中选取视频投币，会根据你今天已经投过的币的数量计算还要投几个币。"
            )
          ])
        },
        share: {
        ...
        medalTasks: {
          list: {
            ...
            message: vue.h("p", [
              vue.h(
                "div",
                "为更精细地控制为哪些粉丝勋章执行任务，你可以使用黑名单或白名单模式。"
              ),
              vue.h("div", [
                vue.h("li", [
                  vue.h("span", "黑名单：仅为"),
              ...
              vue.h(
                "div",
                "点击编辑名单按钮，然后使用第一列的多选框即可编辑名单中的粉丝勋章。"
              )
            ])
          },
          like: {
            ...
            message: vue.h("p", [
              ...
              vue.h("div", [
                vue.h(
                  "span",
                  "如果你不希望等级≥20的粉丝勋章熄灭，可以勾选下面的“包含等级≥20的粉丝勋章”"
                ),
                vue.h(
                  "strong",
          ...
          danmu: {
            ...
            message: vue.h("p", [
              ...
              vue.h("div", [
                vue.h(
                  "span",
                  "点击编辑弹幕按钮编辑发送的弹幕，脚本会从中按顺序循环抽取弹幕发送。"
                ),
    ...
    EnhanceExperience: {
      ...
      invisibility: {
        title: "隐身入场",
        message: vue.h("p", [
          vue.h("div", "进入直播间时其他人（包括主播）不会收到提示。"),
          vue.h("div", [
            vue.h("strong", "缺点："),
            vue.h(
              "span",
              "如果你拥有该直播间的粉丝勋章，本功能会导致你无法通过观看直播获取该粉丝勋章的亲密度。同时，你依然会出现在高能榜上（该问题目前无法解决）"
            )
          ])
        ])
      }
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-ff60cff4"), n = n(), vue.popScopeId(), n);
  ...
  const InfoIcon = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ff60cff4"]]);
